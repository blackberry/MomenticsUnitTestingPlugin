 ...
 * 
 */
public class SupportFileActionProvider extends CommonActionProvider {
	/**
	...
	/**
	 * The new header file action
	 */
	private BaseSelectionListenerAction _newHeaderFileAction;
	...
	public void init(ICommonActionExtensionSite aSite) {
		...
		_newHeaderFileAction = new FileNewAction(FileNewActionType.HEADER_FILE);
	}
	...
	public void fillContextMenu(IMenuManager menu) {
		...
		menu.appendToGroup(ICommonMenuConstants.GROUP_NEW, _newHeaderFileAction);
	}
	...
	public void setContext(ActionContext context) {
		...
		if ((context != null)
			...
			_newHeaderFileAction.selectionChanged(selection);
		}
	}
}
